...
<body>
	...
	-->
		...
		<g:else>
			...
			<g:form action="user_login_function" method="post"
				class="form-signin">
					...
					<table class="userForm">
						<tr class='prop'>
							...
							<td valign='top' style='text-align: left;' width='80%'><input
								...
								class="input-block-level" value='${userlogin?.username}' /></td>
						</tr>
						<tr class='prop'>
							<td valign='top' style='text-align: left;' width='20%'><label
							...
							<td valign='top' style='text-align: left;' width='80%'><input
								...
								class="input-block-level" value='${userlogin?.password}' /></td>
						</tr>
					</table>
				</div>
				...
				<div class="buttons">
					...
					<span class="formButton"> <input type="submit"
						value="Log In" class="btn btn-large btn-info"></input> 
